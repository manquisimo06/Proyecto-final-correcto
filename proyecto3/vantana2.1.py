...
def abrir_pdf():
    ubicasion_pdf='manual de usuario EisyEdyt.pdf'
    webbrowser.open(ubicasion_pdf)
def licencia():
    messagebox.showinfo(message="Licenciado en EisyEdyt\n"
    "Versión 1.0\n"
    "EisyEdyt es un editor de texto desarrollado por Grupo1.\n" "Este software se distribuye bajo la siguiente licencia:\n"
    "1. Uso Personal y No Comercial: EisyEdyt se puede usar de forma gratuita para fines personales y no comerciales.\n""Puedes instalarlo en múltiples dispositivos siempre que sea para tu uso personal.\n"
    "2. Uso Comercial: Para usar EisyEdyt con fines comerciales, se requiere una licencia de pago.\n""Para más información sobre precios y condiciones, Pedirle permiso al ingeniero Melvin Cali.\n"
    "3. Distribución: No está permitido redistribuir EisyEdyt sin el consentimiento previo por escrito de Grupo1.\n"
    "4. Modificaciones: No se permite modificar, descompilar\n"
    "5. Garantía: EisyEdyt se proporciona tal cual no le garantizamos nada lo instalo por su propia cuenta y riesgo XD\n"
    "6. Aceptación de la Licencia: Al instalar y no queremos reclamos de la generación de cristal\n"
    "Para más información comuniques con grupo1@grupo1.gt.com\n", title="informacion general")
...
'''SE INCLUYE ESTE PROTOCOLO PARA NO PERDER DATO CUANDO SE PRECIONA EL BOTON DE CERRAR (x) QUE TRAE POR
DEFECTO EL WIDGET O FORMULARIO'''
